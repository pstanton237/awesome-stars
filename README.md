...
- [askalf/dario](https://github.com/askalf/dario) - Your Claude Pro/Max subscription only works in Claude Code. dario makes it work everywhere — Cursor, Cline, Aider, the Agent SDK, any tool — at subscription pricing, not per-token API bills. One local
...
- [lyvius2/UsedBookApp](https://github.com/lyvius2/UsedBookApp) - 중고책 구매/매각가 검색 앱. A hybrid app for searching used book prices and comparing buyback offers across major Korean bookstores.
...
- [imryche/blockkit](https://github.com/imryche/blockkit) - Build beautiful Slack UIs fast
...
- [andrew-kurin/route53manager](https://github.com/andrew-kurin/route53manager) - Simple GUI for Route 53 Amazon DNS written with Flask and boto
...
- [BugWrestler5000/auto-apply-gcp-iam-recommendations](https://github.com/BugWrestler5000/auto-apply-gcp-iam-recommendations) - Auto apply GCP IAM permissions
...
- [aws-samples/amazon-bedrock-client-for-mac](https://github.com/aws-samples/amazon-bedrock-client-for-mac) - A native macOS client that brings Amazon Bedrock's AI models directly to your desktop. Access Claude Sonnet 4.5, Opus 4, and other foundation models through a clean interface designed for macOS, with 
